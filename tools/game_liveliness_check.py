...
CHECKS = {
    ...
    "ship-specific specialist crew": [
        ...
        "getCrewRosterNote",
        "kont:'19 aktif'",
        "CREW_ROLE_ATLAS_GROUPS",
        "getCrewRoleAtlasPanel",
        "crew-atlas-card",
        "buildSpecialistCrewScenes",
        "getSpecialistCrewKeysForShipType",
        "applyActiveSpecialistCrewToPhone",
        "spec_kont_container_01",
        "spec_bulk_cargo_01",
        "spec_research_hydro_01",
        "spec_cruise_hotel_01",
        "spec_${stype}_pumpman_01",
        "spec_${stype}_deckcrew_01",
        "spec_${stype}_enginecrew_01",
        "spec_${stype}_intlcrew_01",
        "Gemici Başı",
        "Russian Chief Engineer",
        "Filipino Chief Cook",
        "Hidrografik Araştırmacı",
        "Bunkering Zabiti",
        "Gemi İtfaiye Lideri",
    ],
    "localized crew names": [
        "CREW_NAME_POOLS_BY_LANG",
        "getCrewNamePoolForLanguage",
        "localizedCrewNamesForKey",
        "Captain Emily Carter",
        "Capitán Lucía Morales",
        "Kapitän Anna Schneider",
        "Capitaine Claire Moreau",
        "Капитан Анна Соколова",
        "船长 李娜",
    ],
    "realistic chart and radar target markers": [
        "getMapTaskChartSymbol",
        "map-task-callout",
        "map-task-symbol-plate",
        "radar-task-console",
        "renderRadarInteractionVisual",
        "CONTACT B",
        "cpa:'0.4'",
        "radar-contact-choice",
    ],
    ...
    "player bond director": [
        "playerBondState",
        "runPlayerBondDirector",
        "getPlayerBondPanel",
        "getPlayerBondScore",
        "getPlayerBondTheme",
        "KISISEL HAFIZA",
        "OYUNCU BAGLILIK DIREKTORU",
        "AI MATE DEBRIEF",
        "player-bond-panel",
        "player-bond-moments",
    ],
    ...
    "watch director 3 realism systems": [
        "watchDirector3State",
        ...
        "Work/Rest Hours",
        "PSC / Class Surprise Walkthrough",
    ],
    "charter mini mode": [
        "CHARTER_CASES",
        "charterTradeState",
